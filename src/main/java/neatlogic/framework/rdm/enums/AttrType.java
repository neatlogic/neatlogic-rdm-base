...
public enum AttrType implements IEnum<JSONObject> {
    NUMBER("number", "number", new I18n("common.number"), false, false, null),
    TEXT("text", "text", new I18n("common.text"), false, false, null),
    TEXTAREA("textarea", "textarea", new I18n("common.textbox"), false, false, null),
    SELECT("select", "select", new I18n("enum.rdm.attrtype.select"), false, true, null),
    DATE("date", "date", new I18n("common.date"), false, false, null),
    DATETIME("datetime", "datetime", new I18n("common.datatime"), false, false, null),
    TIME("time", "time", new I18n("common.time"), false, false, null),
    FILE("file", "file", new I18n("common.attachment"), false, true, null),
    PRIORITY("priority", "priority", new I18n("common.priority"), true, false, null),
    UESR("user", "user", new I18n("common.user"), false, true, null),
    TAG("tag", "tagList", new I18n("common.tag"), true, true, null),
    WORKER("worker", "userIdList", new I18n("common.worker"), true, true, null),
    CATALOG("catalog", "catalog", new I18n("common.directory"), true, false, null),
